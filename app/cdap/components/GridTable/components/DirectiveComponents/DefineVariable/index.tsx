...
const DefineVariable = ({
  ...
  const [filterCondition, setFilterCondition] = useState<string>('TEXTEXACTLY');
  ...
  useEffect(() => {
    setDirectiveComponentsValue((prevState) => ({ ...prevState, filterCondition }));
  }, [filterCondition]);

  useEffect(() => {
    setDirectiveComponentsValue((prevState) => ({ ...prevState, variableName }));
  }, [variableName]);
  ...
  useEffect(() => {
    setDirectiveComponentsValue((prevState) => ({ ...prevState, customInput }));
  }, [customInput]);
      ...
      <FormGroup>
        ...
        <FormControl>
          <SelectInputComponent
            ...
            options={directiveComponentValues.columnNames}
          />
        </FormControl>
      </FormGroup>
