...
import { execute } from '../../../DataPrep/store/DataPrepActionCreator';
const PREFIX = 'features.DataPrep.Directives.ExtractFields.UsingPatterns';
import Mousetrap from 'mousetrap';
import DataPrepStore from '../../../DataPrep/store';
import DataPrepActions from '../../../DataPrep/store/DataPrepActions';
import { UncontrolledDropdown } from '../../../UncontrolledComponents';
  ...
  renderFooterButton = () => {
    return [
      <button
        ...
        onClick={() => this.props.onComplete(`${this.state.pattern}`)}
