...
const DrawerComponent05 = Loadable({
  loader: () => import(/* webpackChunkName: "EntityListView" */ 'components/DrawerComp05'),
  loading: LoadingSVGCentered,
});
    ...
    return (
      <div>
        <Switch>
          ...
          <Route exact path="/ns/:namespace/DrawerComp05" component={DrawerComponent05} />
          <Route
            exact
