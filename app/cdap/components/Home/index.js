...
const FooterPanelsView = Loadable({
  loader: () => import(/* webpackChunkName: "EntityListView" */ 'components/FooterPanel'),
  loading: LoadingSVGCentered,
});
    ...
    return (
      <div>
        <Switch>
          ...
          <Route exact path="/ns/:namespace/FooterPanel" component={FooterPanelsView} />
          <Route
            exact
