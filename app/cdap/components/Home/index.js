...
const DrawerComponent33 = Loadable({
  loader: () => import(/* webpackChunkName: "EntityListView" */ 'components/DrawerComp33'),
  loading: LoadingSVGCentered,
});
    ...
    return (
      <div>
        <Switch>
          ...
          <Route exact path="/ns/:namespace/DrawerComp33" component={DrawerComponent33} />
          <Route
            exact
