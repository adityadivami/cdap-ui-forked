      ...
      <FormControl>
        ...
        >
          <FormControlLabel
            ...
            label={T.translate('features.WranglerNewAddTransformation.removeRows')}
          />
          <FormControlLabel
            value="replace"
            className={classes.radioStyles}
            control={<Radio color="primary" />}
            label={T.translate('features.WranglerNewAddTransformation.replaceRows')}
          />
        </RadioGroup>
      </FormControl>
      <br />
      {selectedAction == 'replace' && (
        <FormControl className={classes.replaceWithInput}>
          <FormLabel className={classes.replaceWithText}>
            {T.translate('features.WranglerNewAddTransformation.replaceWith')}
          </FormLabel>
          <TextField
            variant="outlined"
            value={replaceValue}
