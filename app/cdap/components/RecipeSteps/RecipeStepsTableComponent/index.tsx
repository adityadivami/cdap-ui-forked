...
const RecipeStepWrapper = styled(TableContainer)`
...
export default function({ recipeSteps }: IRecipeStepTableProps) {
  return (
    <RecipeStepWrapper component={Box} data-testid="recipe-step-container">
