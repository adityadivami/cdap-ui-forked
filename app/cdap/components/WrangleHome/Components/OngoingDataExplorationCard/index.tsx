        ...
        switch (eachItem.type) {
          ...
          case 'text':
            return eachItem.label.includes('Recipe steps') ? (
              <Grid item xs={3} className={classes.elementStyle} key={index} data-testid={`wrangler-home-ongoing-data-exploration-card-text-${index}`}>
          ...
          case 'percentageWithText': {
            ...
            return percent && !isNaN(percent) ? (
              ...
              <Grid item xs={3} data-testid={`wrangler-home-ongoing-data-exploration-card-percentageWithText-${index}`}></Grid>
            );
          }
