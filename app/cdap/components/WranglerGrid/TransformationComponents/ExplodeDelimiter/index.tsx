...
const DELIMITER_OPTION_EXPLODE = [
    {
        value: ',',
        label: `${T.translate(
            `${PREFIX}.explodeDelimiterOptions.comma`
        )}`,
    },
    {
        value: '\\t',
        label: `${T.translate(
            `${PREFIX}.explodeDelimiterOptions.tab`
        )}`,
    },
    {
        value: '\\s+',
        label: `${T.translate(
            `${PREFIX}.explodeDelimiterOptions.whitespace`
        )}`,
    },
    {
        value: '\\|',
        label: `${T.translate(
            `${PREFIX}.explodeDelimiterOptions.pipe`
        )}`,
    },
    {
        value: 'customDelimiter',
        label: `${T.translate(
            `${PREFIX}.explodeDelimiterOptions.customDelimiter`
        )}`,
    },
];
