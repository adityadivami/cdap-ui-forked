...
import DetailContainer from 'components/RecipeDetails/DetailContainer/';
...
describe('Test RecipeDetails Component', () => {
  it('should check if the recipe name is as expected', () => {
    render(<DetailContainer recipeDetails={recipeDetailsMockData} />);
  ...
  it('should check if the RecipeStepText is as expected when recipe step >10', () => {
    render(<DetailContainer recipeDetails={recipeDetailsMockData2} />);
    const recipeStepIndex = screen.getByTestId(/recipe-step-index-0/i);
    expect(recipeStepIndex).toHaveTextContent('01');
  });
});
